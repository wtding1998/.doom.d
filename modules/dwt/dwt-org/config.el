...
(use-package! org-pomodoro
  ...
  (defun dwt/org-pomodoro-start-reminder ()
    (let* ((org-pomodoro-finish-answer-list '("5" "10" "15" "20" "Yes"))
           (org-pomodoro-finish-answer (consult--read org-pomodoro-finish-answer-list :prompt "Continue? "))
           (org-pomodoro-length (string-to-number org-pomodoro-finish-answer)))
      (if (> org-pomodoro-length 0)
        (run-with-timer (* org-pomodoro-length 60) nil #'dwt/org-pomodoro-start-reminder)
        (org-pomodoro '(16)))))
